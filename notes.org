...
***** get <<<ng:http:get>>>
http.get() returns an Observable<Response>
...
*** Route
**** base href and config routes
https://github.com/coursefiles/angular2-essential-training/tree/07_02b/app
...
**** Register routing in the app module
