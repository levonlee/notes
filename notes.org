...
,GROUP_CONCAT(c.course SEPARATOR ', ') AS courses
...
Also concatenate null values as empty values:
~GROUP_CONCAT(IFNULL(c.course,'') SEPARATOR ', ') AS courses~

If column values are strings, use this
...
INSERT INTO testScore ( sid, score )
VALUES 
( 1, 20 ),
( 1, 30 ),
( 2, 40 )
