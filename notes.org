...
#+BEGIN_EXAMPLE
<div id="interstitial">
 <!-- script tag inside the container will be run twice! 
...
On website, interstitial.js :: make ad unit div as a dialog using jQuery UI.
...
#+BEGIN_EXAMPLE
jQuery(function(){
  var targetDialog = '#div-gpt-ad-1403025754774-0-oop';
