...
*** QuickStart
[[https://embed.plnkr.co/?show%3Dpreview&show%3Dapp%252Fapp.component.ts][Online playground]]
...
Restart then open a command prompt, run ~bash~ and type ~y~ to install Ubuntu on Windows.
