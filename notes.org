...
To group a bs:dropdown with <button>s, use div.btn-group to wrap them all together.
...
<div class="dropdown open">
  ...
  <!-- BS4 no longer requires menu items to be <a> -->
...
<div class="btn-group">
  ...
  <button
    ...
    aria-haspopup="true"
    aria-expanded="false">
    <!-- .dropdown-toggle-split is BS4.
          BS3 requires the line below to add caret -->
