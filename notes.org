...
"dependencies": {
    ...
    "@angular/platform-browser": "~4.0.0", // DOM and browser related. Help render into DOM.
...
**** Bind DOM properties to a variable, or the other way around
#+BEGIN_EXAMPLE
// Instead of
