...
** Global and Content inside a column
...
728px :: requires md-12, lg-9, xg-8
300px :: requries md-5, lg-4, xg-3
...
#+BEGIN_EXAMPLE
<div class="media">
  <!-- may add media-middle, media-bottom, default is top -->
...
Add role="button" for <a> without a link e.g. '#'
...
*** Form
- Add .sr-only to <label> to hide it
- add .form-control to <input>, <select>, <textarea> to make it width 100%
- wrap each form field with div.form-group to add margin-bottom
- By default, <form> doesn't have to have any class
- add .form-inline to <form> and any form field to make it inline. Only works for md and above viewport sizes

Checkbox and radio (.radio, .radio-inline)
<div class="checkbox">
  <label>
...
- \ :: line, arc, spiral, rectangular grids, polar grid. Hold Shift for straight line, round circle, etc.
- 
