...
- Native font stack is switched from Helvetica Neue, Helvetica and Arial to:
  - -apply-system (Safari for OS X and iOS)
  - BlinkMacSystemFont (Chrome for OS X)
  - Segoe UI (Windows)
  - Robot (Android)
  - Helvetica Neue, Arial, sans-serif !default;
- heading elements and <p> have margin-top removed
  - heading elements :: margin-bottom: .5rem (p.h1, p.h2, etc.)
  - <p> :: margin-bottom: 1rem
- Lists <ul> <ol> <dl> :: have margin-top removed
  - margin-bottom: 1rem
  - Except nested lists
...
<!-- center an image, round image border-radius: 50% -->
...
- Add class="table" to <table>
  ...
  - add .table-bordered
  - add .table-hover
  - add .table-sm to remove cell padding
  - add .table-reflow to transpose
- Add scope="row" to the first td (or th) in each <tr>
...
- Add colors to rows or individual cells. If table-inverse, use bg-* or text-*
  - .table-active :: light grey
  - .table-success :: light green
  - .table-info :: light blue
  - .table-warning :: light yellow
  - .table-danger :: light red
